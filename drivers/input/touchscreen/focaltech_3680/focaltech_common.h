...
#define FTS_DEBUG(fmt, args...) do { \
    printk("[FTS_TS][Baikal]%s:"fmt"\n", __func__, ##args); \
} while (0)

#define FTS_FUNC_ENTER() do { \
    printk("[FTS_TS][Baikal]%s: Enter\n", __func__); \
} while (0)

#define FTS_FUNC_EXIT() do { \
    printk("[FTS_TS][Baikal]%s: Exit(%d)\n", __func__, __LINE__); \
} while (0)
...
#define FTS_INFO(fmt, args...) do { \
    printk(KERN_INFO "[FTS_TS/I][Baikal]%s:"fmt"\n", __func__, ##args); \
} while (0)

#define FTS_ERROR(fmt, args...) do { \
    printk(KERN_ERR "[FTS_TS/E][Baikal]%s:"fmt"\n", __func__, ##args); \
} while (0)
